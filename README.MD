...
Built-in data for the **United States** (<!-- zpl:us:codes -->43,265<!-- /zpl:us:codes --> ZIP codes), **Canada** (~<!-- zpl:ca:codes -->900,688<!-- /zpl:ca:codes --> postal codes, <!-- zpl:ca:entries -->431k<!-- /zpl:ca:entries --> compressed entries via FSA range compression), and **Mexico** (<!-- zpl:mx:codes -->32,652<!-- /zpl:mx:codes --> postal codes). All three countries are fully curated ✅.
...
|---------|-------------------------------------------------------:|:------------:|:---------------------------------------:|------------|
| US      |  **<!-- zpl:us:codes -->43,265<!-- /zpl:us:codes -->** |    State     | <!-- zpl:us:tz -->53<!-- /zpl:us:tz --> | ✅ Curated  |
| CA      | **<!-- zpl:ca:codes -->900,688<!-- /zpl:ca:codes -->** |   Province   | <!-- zpl:ca:tz -->21<!-- /zpl:ca:tz --> | ✅ Curated  |
| MX      |  **<!-- zpl:mx:codes -->32,652<!-- /zpl:mx:codes -->** |    Estado    | <!-- zpl:mx:tz -->10<!-- /zpl:mx:tz --> | ✅ Curated  |

\* Distinct codes are the number of unique Zip/Postal codes in the country's set.

Code Counts and status, last updated on: **(<!-- zpl:updated -->2026-06-07 00:02:38<!-- /zpl:updated -->)**
